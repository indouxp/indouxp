...
金融系システムを中心に、サーバー構築からスクリプト開発まで、「作る、安定させる」エンジニアとして歩んできました。Oracle RAC・Unix/Linuxの構築と、Python・Shell・PowerShellによる自動化・運用改善を並行して手がけてきました。これらの経験を、クラウド環境の構築・開発に活かしていきたいと考えています。<br>
